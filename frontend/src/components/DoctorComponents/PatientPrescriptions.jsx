...
export const PatientPrescriptions = () => {
    ...
    const { userMedicalData, userData, setDoctorData, doctorData, setUserData, setUserMedicalData, cookies, setSuccess } = useContext(AppContext);
    ...
    const handleEditSubmit = async () => {
        ...
        if (diagnosisImage) {
            ...
            if (cookies.type === "Doctor") {
                formData.append("doctor", doctorData?.doctor_name);
            }
            else {
    ...
    const handleSubmit = async () => {
        ...
        if (date && doctor && dosage && diagnosisImage && frequency && notes && medication) {
            ...
            console.log(!date + " " + doctor + " " + !dosage + " " + !diagnosisImage + " " + !frequency + " " + !notes + " " + !medication)
        }
